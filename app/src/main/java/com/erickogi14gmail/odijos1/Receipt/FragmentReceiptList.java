...
import com.erickogi14gmail.odijos1.utills.RecyclerTouchListener;
...
public class FragmentReceiptList extends Fragment {
    ...
    private void insertItems() {
        ...
        for (int a = 0; a < 20; a++) {
            if ((a & 1) == 0) {
                ReceiptPojo receiptPojo = new ReceiptPojo(a, "Full Odijo Names", "Course Name", "1" + a + "/Sep/2017", a + "000",
                        "4hrs 30 mins");
